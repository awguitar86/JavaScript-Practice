...
"HELLO! Today is going to be a GREAT DAY!".grammarPolice();
...
//   }
//   else if(one == two && typeof one !== typeof two){
...
const valueType = (one, two) => one === two ? "Exactly the same" : one == two ? "Same value, different types" : "Different values";
